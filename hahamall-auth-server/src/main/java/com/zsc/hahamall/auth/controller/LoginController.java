...
import com.zsc.hahamall.auth.feign.MemberFeignService;
import com.zsc.hahamall.auth.feign.ThirdPartFeignService;
...
public class LoginController {
	...
	public String loginPage(HttpSession session){
		...
		return "redirect:http://hahamall.com";
	}
